                  ...
                  <tr>
                    {["DATE", "OPPONENT", "RESULT", "PTS", "REB", "AST"].map(
                      (header) => (
                        <th
                          key={header}
                          className="px-3 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-[color:var(--subtitle-color)]"
                        >
                          {header}
                        </th>
                      ),
                ...
                <tbody>
                  {boxScores.map((row, index) => (
                    ...
                    >
                      ...
                      <td className="rounded-r-xl px-3 py-3 text-sm">
                        {row.ast || "-"}
                      </td>
                    </tr>
                  ))}
            ...
            >
              ...
              <div className="grid gap-x-10 gap-y-3 sm:grid-cols-2">
                ...
                <DetailItem
                  ...
                  value={String(
                    player.memberSinceYear ??
                      new Date().getFullYear() - yearsSince,
                  )}
                />
              </div>
            </motion.div>
...
function DetailItem({ label, value }: DetailItemProps) {
  return (
    <div>
      ...
      <p className="mt-1 text-base font-semibold text-[color:var(--title-color)]">
        {value}
      </p>
    </div>
  );
