...
export default function ScheduleSection({ schedule }: ScheduleSectionProps) {
  ...
  return (
    <SectionReveal id="schedule" className="px-5 py-14 sm:px-8 lg:px-12">
      <div className="mx-auto mt-[-80] max-w-7xl overflow-hidden rounded-3xl border border-[color:var(--title-color)]/14 bg-[linear-gradient(150deg,color-mix(in_srgb,var(--background)_92%,var(--surface)_8%)_0%,color-mix(in_srgb,var(--background)_80%,var(--title-color)_20%)_45%,color-mix(in_srgb,var(--background)_82%,var(--subtitle-color)_18%)_100%)] shadow-[0_22px_60px_color-mix(in_srgb,var(--accent-shadow)_30%,transparent)] [--outline-soft:color-mix(in_srgb,var(--subtitle-color)_52%,var(--title-color)_48%)] [--outline-deep:color-mix(in_srgb,var(--title-color)_72%,var(--subtitle-color)_28%)]">
